...
public class SpellInterface extends Bar{
	...
	public SpellInterface(Interface parent){
		this.parent = parent;
		this.x = 0;
		this.y = 0;
		...
		this.foi = Images.get("imageSpecial");
	}
	...
	public Graphics draw(Graphics g){
		...
		this.c = Game.g.currentPlayer.getTeam().civ;
		Utils.drawNiceRect(g, Game.g.currentPlayer.getTeam().color, x, y, sizeX, sizeY);
		Image im = Images.get("spell"+c.uniqueSpell.name);
		...
		g.setColor(Game.g.currentPlayer.getTeam().color);
