...
public class ObjectBar {
	...
	public ObjectBar(MapEditor editor){
		...
		this.startX = 4*editor.game.resX/5f;
		...
		// dualists
		// blue
		unitsDualistsBlue.add(new EditorObject("Spearman", 1, 0,this.editor.game.images.spearmanBlue,0,0,this));
		unitsDualistsBlue.add(new EditorObject("Crossbowman", 1, 0,this.editor.game.images.crossbowmanBlue,0,0,this));
		unitsDualistsBlue.add(new EditorObject("Knight", 1, 0,this.editor.game.images.knightBlue,0,0,this));
		unitsDualistsBlue.add(new EditorObject("Inquisitor", 1, 0,this.editor.game.images.inquisitorBlue,0,0,this));
		unitsDualistsBlue.add(new EditorObject("Archange", 1, 0,this.editor.game.images.archangeBlue,0,0,this));
		// red
		unitsDualistsRed.add(new EditorObject("Spearman", 2,0, this.editor.game.images.spearmanRed,0,0,this));
		unitsDualistsRed.add(new EditorObject("Crossbowman", 2, 0,this.editor.game.images.crossbowmanRed,0,0,this));
		unitsDualistsRed.add(new EditorObject("Knight", 2, 0,this.editor.game.images.knightRed,0,0,this));
		unitsDualistsRed.add(new EditorObject("Inquisitor", 2,0, this.editor.game.images.inquisitorRed,0,0,this));
		unitsDualistsRed.add(new EditorObject("Archange", 2,0, this.editor.game.images.archangeRed,0,0,this));
		
		// buildings
		// neutral
		buildingsNeutral.add(new EditorObject("Mill", 0, 1,this.editor.game.images.buildingMillNeutral,0,0,this));
		buildingsNeutral.add(new EditorObject("Mine", 0, 1,this.editor.game.images.buildingMineNeutral,0,0,this));
		buildingsNeutral.add(new EditorObject("Barrack", 0,1, this.editor.game.images.buildingBarrackNeutral,0,0,this));
		buildingsNeutral.add(new EditorObject("Stable", 0, 1,this.editor.game.images.buildingStableNeutral,0,0,this));
		buildingsNeutral.add(new EditorObject("Academy", 0, 1,this.editor.game.images.buildingAcademyNeutral,0,0,this));
		buildingsNeutral.add(new EditorObject("University", 0, 1,this.editor.game.images.buildingUniversityNeutral,0,0,this));
		buildingsNeutral.add(new EditorObject("Tower", 0, 1,this.editor.game.images.buildingTowerNeutral,0,0,this));
		// blue
		buildingsBlue.add(new EditorObject("Mill", 1, 1,this.editor.game.images.buildingMillBlue,0,0,this));
		buildingsBlue.add(new EditorObject("Mine", 1, 1,this.editor.game.images.buildingMineBlue,0,0,this));
		buildingsBlue.add(new EditorObject("Barrack", 1, 1,this.editor.game.images.buildingBarrackBlue,0,0,this));
		buildingsBlue.add(new EditorObject("Stable", 1, 1,this.editor.game.images.buildingStableBlue,0,0,this));
		buildingsBlue.add(new EditorObject("Academy", 1, 1,this.editor.game.images.buildingAcademyBlue,0,0,this));
		buildingsBlue.add(new EditorObject("University", 1, 1,this.editor.game.images.buildingUniversityBlue,0,0,this));
		buildingsBlue.add(new EditorObject("Tower", 1, 1,this.editor.game.images.buildingTowerBlue,0,0,this));
		buildingsBlue.add(new EditorObject("HeadQuarters", 1, 1,this.editor.game.images.buildingHeadQuartersBlue,0,0,this));
		// red
		buildingsRed.add(new EditorObject("Mill", 2, 1,this.editor.game.images.buildingMillRed,0,0,this));
		buildingsRed.add(new EditorObject("Mine", 2, 1,this.editor.game.images.buildingMineRed,0,0,this));
		buildingsRed.add(new EditorObject("Barrack", 2, 1,this.editor.game.images.buildingBarrackRed,0,0,this));
		buildingsRed.add(new EditorObject("Stable", 2, 1,this.editor.game.images.buildingStableRed,0,0,this));
		...
		others.add(new EditorObject("BonusDamage", 0,2, this.editor.game.images.bonusDamage,0,0,this));
		others.add(new EditorObject("BonusSpeed", 0, 2,this.editor.game.images.bonusSpeed,0,0,this));
		
		// nature
		nature.add(new EditorObject("Tree", 0, 3,this.editor.game.images.tree01, 0, 0,this));
		nature.add(new EditorObject("Tree", 1, 3,this.editor.game.images.tree02, 0, 0,this));
